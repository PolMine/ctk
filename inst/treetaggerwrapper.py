...
class TreeTagger (object) :
    ...
    def StartProcess(self) :
        ...
        try :
            #self.taginput,self.tagoutput = os.popen2(tagcmd) # Korrektur folgt da popen2 veraltet
            p = subprocess.Popen(tagcmd, shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE, close_fds=True)
